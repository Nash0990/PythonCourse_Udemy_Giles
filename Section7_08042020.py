...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  8 01:48:56 2020
...
for letter in sherlock:
    ...
    #The reason for putting 0 inside lettet_count.get() is to return 0 instead of a false boolean on the first iteration.
...
for i,j in letter_count.items():
    if i.isalpha():
        letter_count_clean[i]=j
print(letter_count_clean)


plt.bar(letter_count_clean.keys(),letter_count_clean.values())
...
k,v=zip(*capitals.items())

#Stings Contid..

new_word=sherlock.split(" ")
...
print(countries['France'])  #output is {'Capital': 'Rome', 'Language': 'Italian'}
print(countries['France']['Capital']) #output is 'Rome'

print(countries.items())

for key,value in countries.items():
    print(f"The capital of {key} is {value['Capital']} and the language they speak is {value['Language']}")
